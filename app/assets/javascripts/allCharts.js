...
//Note to self: READ YOUR OWN DOCS, DUMMY!
//Alright so as of 9/20/18 12:43P.M. EDT one can only have ONE js file with the charts in it, rendered on ONE page. No splitting up and mixing and matching.
window.onload = function() {
  var carbonDioxideChart = new CanvasJS.Chart("carbonDioxideChartContainer", {
    ...
    axisX: {
      labelAngle: -30,
      maximum: 2090,
      valueFormatString: '#### A.D.', //easier than messing with dates for now
      interval: 250,
    },
    axisY: {
     includeZero: false
    ...
    data: [ //array of dataseries
      ...
      //2011 - 2017 ftp://aftp.cmdl.noaa.gov/products/trends/co2/co2_annmean_mlo.txt
      type: "line",
      ...
      { x: 2015, y: 400.83 },
      { x: 2016, y: 404.21 },
      { x: 2017, y: 406.53, indexLabel: "406.53", markerColor: "red", markerType: "triangle" }
